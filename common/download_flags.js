...
let downloadFlags = async () => {
    let codes = [
        ...
        'SS', 'ST', 'SV', 'SX', 'SY', 'SZ', 'TA', 'TC', 'TD', 'TF', 'TG', 'TH', 'TJ', 'TK', 'TL', 'TM', 'TN', 'TO', 'TR', 'TT', 'TV', 'TW', 'TZ', 'UA', 'UG', 'US', 
        'UY', 'UZ', 'VA', 'VC', 'VE', 'VG', 'VI', 'VN', 'VU', 'WF', 'WS', 'XK', 'YE', 'YT', 'ZA', 'ZM'
    ]
    const https = require('https');
    for (let c of codes){
        let file = fs.createWriteStream(`./assets/imgs/flags/${c}.svg`);
        let path = `https://purecatamphetamine.github.io/country-flag-icons/3x2/${c}.svg`;
