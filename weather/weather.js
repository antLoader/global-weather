...
const getWeathers = async cityId => await axios.get(`https://api.openweathermap.org/data/2.5/weather?id=${cityCsvIds}&appid=${APIkey}&units=metric&lang=sp`);
module.exports = { getWeather, getWeathers }
